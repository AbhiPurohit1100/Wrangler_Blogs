      ...
      <Card className="w-full max-w-md backdrop-blur-sm bg-white/10 border-white/20 shadow-2xl">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <input
                id="remember"
                type="checkbox"
                className="w-4 h-4 text-gray-600 bg-white/10 border-white/20 rounded focus:ring-gray-400 focus:ring-2"
              />
          ...
          <div className="text-center text-sm text-gray-300">
            ...
            <Link className="text-gray-400 hover:text-gray-300 underline transition-colors" to={"/signup"}>Sign up</Link>
          </div>
        </CardContent>
      </Card>
